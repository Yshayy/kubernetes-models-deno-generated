...
import { addSchema as IoK8sApiStorageV1beta1CSINode } from "./IoK8sApiStorageV1beta1CSINode.ts";
...
const schema: object = {
  "properties": {
    ...
    "items": {
      "items": {
        "$ref": "io.k8s.api.storage.v1beta1.CSINode#"
      },
      "type": "array"
    },
    "kind": {
...
register("io.k8s.api.storage.v1beta1.CSINodeList", schema);
}
