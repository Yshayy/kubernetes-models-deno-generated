...
import { addSchema as IoK8sApiAuthorizationV1beta1SelfSubjectAccessReviewSpec } from "./IoK8sApiAuthorizationV1beta1SelfSubjectAccessReviewSpec.ts";
...
const schema: object = {
  "properties": {
    ...
    "spec": {
      "$ref": "io.k8s.api.authorization.v1beta1.SelfSubjectAccessReviewSpec#"
    },
    "status": {
...
register("io.k8s.api.authorization.v1beta1.SelfSubjectAccessReview", schema);
}
