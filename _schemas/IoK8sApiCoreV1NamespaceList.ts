...
import { addSchema as IoK8sApiCoreV1Namespace } from "./IoK8sApiCoreV1Namespace.ts";
...
const schema: object = {
  "properties": {
    ...
    "items": {
      "items": {
        "$ref": "io.k8s.api.core.v1.Namespace#"
      },
      "type": "array"
    },
    "kind": {
...
register("io.k8s.api.core.v1.NamespaceList", schema);
}
