...
import { addSchema as IoK8sApiRbacV1beta1ClusterRole } from "./IoK8sApiRbacV1beta1ClusterRole.ts";
...
const schema: object = {
  "properties": {
    ...
    "items": {
      "items": {
        "$ref": "io.k8s.api.rbac.v1beta1.ClusterRole#"
      },
      "type": "array"
    },
    "kind": {
...
register("io.k8s.api.rbac.v1beta1.ClusterRoleList", schema);
}
