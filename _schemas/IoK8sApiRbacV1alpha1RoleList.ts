...
import { addSchema as IoK8sApiRbacV1alpha1Role } from "./IoK8sApiRbacV1alpha1Role.ts";
...
const schema: object = {
  "properties": {
    ...
    "items": {
      "items": {
        "$ref": "io.k8s.api.rbac.v1alpha1.Role#"
      },
      "type": "array"
    },
    "kind": {
...
register("io.k8s.api.rbac.v1alpha1.RoleList", schema);
}
