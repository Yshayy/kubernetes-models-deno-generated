...
import { addSchema as IoK8sApiCoreV1LimitRange } from "./IoK8sApiCoreV1LimitRange.ts";
...
const schema: object = {
  "properties": {
    ...
    "items": {
      "items": {
        "$ref": "io.k8s.api.core.v1.LimitRange#"
      },
      "type": "array"
    },
    "kind": {
...
register("io.k8s.api.core.v1.LimitRangeList", schema);
}
