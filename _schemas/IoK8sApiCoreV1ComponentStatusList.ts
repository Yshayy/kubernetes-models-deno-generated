...
import { addSchema as IoK8sApiCoreV1ComponentStatus } from "./IoK8sApiCoreV1ComponentStatus.ts";
...
const schema: object = {
  "properties": {
    ...
    "items": {
      "items": {
        "$ref": "io.k8s.api.core.v1.ComponentStatus#"
      },
      "type": "array"
    },
    "kind": {
...
register("io.k8s.api.core.v1.ComponentStatusList", schema);
}
