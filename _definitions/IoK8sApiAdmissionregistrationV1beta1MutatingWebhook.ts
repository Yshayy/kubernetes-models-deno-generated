...
import { addSchema } from "../_schemas/IoK8sApiAdmissionregistrationV1beta1MutatingWebhook.ts";

/**
 * MutatingWebhook describes an admission webhook and the resources and operations it applies to.
 */
export interface IIoK8sApiAdmissionregistrationV1beta1MutatingWebhook {
/**
 ...
 * MutatingWebhook describes an admission webhook and the resources and operations it applies to.
 */
export class IoK8sApiAdmissionregistrationV1beta1MutatingWebhook extends Model<IIoK8sApiAdmissionregistrationV1beta1MutatingWebhook> implements IIoK8sApiAdmissionregistrationV1beta1MutatingWebhook {
...
Model.setSchema(IoK8sApiAdmissionregistrationV1beta1MutatingWebhook, "io.k8s.api.admissionregistration.v1beta1.MutatingWebhook", addSchema);

export {
  IIoK8sApiAdmissionregistrationV1beta1MutatingWebhook as IMutatingWebhook,
  IoK8sApiAdmissionregistrationV1beta1MutatingWebhook as MutatingWebhook
};
